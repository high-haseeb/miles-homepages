      ...
      <div className="h-[100px] flex items-center gap-x-[135px]">
        ...
        <div className="flex items-center">
          ...
          <Input
            ...
            disabled
          />
          <button className="py-3 px-4 border-none text-xs text-orange-600 font-medium underline">
            (Edit)
          </button>
        </div>
      </div>
      ...
      <div className="h-[100px] flex items-center gap-x-[135px]">
        ...
        <div className="flex items-center">
          ...
          <div className="flex items-center gap-1 w-full">
            ...
            <button className="py-3 px-4 border-none text-xs text-slate9600 font-medium">
              (Click to reverify)
            </button>
          </div>
        </div>
