  ...
  const iconUrl =
    ...
    <svg width="66" height="80" viewBox="0 0 66 80" fill="none" xmlns="http://www.w3.org/2000/svg">
      <mask id="path-1-inside-1_275_12319" fill="white">
        <path fillRule="evenodd" clip-rule="evenodd" d="M41.651 64.8544C55.6802 61.0535 66 48.2319 66 33C66 14.7746 51.2254 0 33 0C14.7746 0 0 14.7746 0 33C0 48.2319 10.3198 61.0535 24.349 64.8544L33 79.8384L41.651 64.8544Z"/>
      </mask>
      <path fillRule="evenodd" clip-rule="evenodd" d="M41.651 64.8544C55.6802 61.0535 66 48.2319 66 33C66 14.7746 51.2254 0 33 0C14.7746 0 0 14.7746 0 33C0 48.2319 10.3198 61.0535 24.349 64.8544L33 79.8384L41.651 64.8544Z" fill="#019D45"/>
